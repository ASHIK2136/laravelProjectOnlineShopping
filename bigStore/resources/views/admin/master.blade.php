...
<html>
    <head>
        ...
        <!-- //jQuery -->
        <link href='{{asset('public/admin')}}//fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet' type='text/css'/>
        <link href='{{asset('public/admin')}}//fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
        <!-- lined-icons -->
    ...
    <body>
        <div class="page-container">
            ...
            <div class="left-content">
                        <h1 class="text-center text-uppercase text-success">Online Shopping System</h1>            
                    @yield('body')   
